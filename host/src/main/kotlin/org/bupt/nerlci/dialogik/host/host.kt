package org.bupt.nerlci.dialogik.host

import org.bupt.nerlci.dialogik.DialogikScript
import java.io.File
...
fun evalFile(scriptFile: File): ResultWithDiagnostics<EvaluationResult> {
    val compilationConfiguration = createJvmCompilationConfigurationFromTemplate<DialogikScript> {
        jvm {
